...
namespace mcutil {
	...
	*/
	...
	public:
		...
		const std::string& gpuName() const { return this->_gpu_name; }
		size_t numberofShader() const { return this->_number_of_shader; }
		size_t numberofSM() const { return this->_number_of_sm; }

		size_t thread() const { return this->_thread; }
		size_t blockPerSM() const { return this->_block_per_sm; }
