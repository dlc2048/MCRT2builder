...
namespace mcutil {
    ...
    constexpr int SIZE_SHARED_MEMORY_PER_THREAD_GLOBAL = 48;
    constexpr int SIZE_SHARED_MEMORY_PER_THREAD_QMD    = 128;
    constexpr int SIZE_SHARED_MEMORY_PER_THREAD_INCL   = 48;
    constexpr int SIZE_SHARED_MEMORY_PER_THREAD_PEVAP  = 64;


    // shared memory size (will be obsolated)
