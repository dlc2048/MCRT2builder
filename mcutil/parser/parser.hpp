...
namespace mcutil {
    ...
    */
    ...
    protected:
        ...
        std::string _desc;   //! @brief Field description
        ...
        */
        ArgumentInterface(
            ...
            bool has_range,
            int  size
        ) : _field(field), _desc(desc), _is_required(is_required), _has_range(has_range), _size(size) {}
    ...
    public:
        ...
        */
        ...
        const std::string& desc() const { return this->_desc; }
        ...
        virtual std::string dataType() const { return ""; }


        virtual void printHelp(size_t global_indent) const;
    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        * @brief Retrieve the name of the data type (str)
        */
    ...
    public:
        ...
        OptionEntry(const std::string& key, int option_numeric, const std::string& desc)
            : _key(key), _desc(desc), _option_numeric(option_numeric) {}
        ...
        int numericOption() const { return this->_option_numeric; }
    ...
    class OptionArgument : public Argument<std::string> {
    protected:
        std::set<OptionEntry> _options;  // options
        size_t _max_length_option_key;
    ...
    public:
        ...
        std::vector<std::string> getOptionLiteralList() const;


        void printHelp(size_t global_indent) const;
    ...
    */
    ...
    private:
        ...
        size_t      _field_max_length;  //! @brief Field max length (for syntax printing)
    ...
    public:
        ...
        * @param key Card name
        */
        ArgumentCard(const std::string& key) : _key(key), _field_max_length(0u) {}


        size_t fieldMaxLength() { return this->_field_max_length; }
